...
const RsSectionRelatedPostsHero = () => {
    return (
                   ...
                   <div className="content">
                       <div className="content-img">
                           <NavLink to='/main/Then going through some small strange motions'>
                               <img src="../img-news/Link-img/link-4.jpg"/>
                           </NavLink>
                       </div>
                       <div className="content-info">
                           <NavLink to='/main/Then going through some small strange motions'>  <h2 className="style-title">I shouted above the sudden noise.</h2></NavLink>
                   ...
                   <div className="content">
                       <div className="content-img">
                           <NavLink to='/main/Two long weeks I wandered'>
                               <img src="../img-news/Link-img/link-5.jpg"/>
                           </NavLink>
                       </div>
                       <div className="content-info">
                           <NavLink to='/main/Two long weeks I wandered'>
                               <h2 className="style-title">A great thing made of gold. Down the hill I saw it.</h2></NavLink>
                   ...
                   <div className="content">
                       <div className="content-img">
                           <NavLink to='/main/At daybreak of the fifteenth day of my search'>
                               <img src="../img-news/Link-img/link-6.jpg"/></NavLink>
                       </div>
                       <div className="content-info">
                           <NavLink to='/main/At daybreak of the fifteenth day of my search'>  <h2 className="style-title">It is very curious to watch this</h2></NavLink>
                   ...
                   <div className="content">
                       <div className="content-img">
                           <NavLink to='/main/We Are Testing A Pagination Here'>
                               <img src="../img-news/Link-img/link-7.jpg"/></NavLink>
                       </div>
                       <div className="content-info">
                           <NavLink to='/main/We Are Testing A Pagination Here'>  <h2 className="style-title">Testing images in the post</h2></NavLink>
...
export default RsSectionRelatedPostsHero;