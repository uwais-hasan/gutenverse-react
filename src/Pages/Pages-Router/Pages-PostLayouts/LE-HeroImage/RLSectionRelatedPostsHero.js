...
const RlSectionRelatedPostsHero = () => {
    return (
        <div className='section-post-relatedPost-RL'>
                    ...
                    <div className="content">
                        <div className="content-img">
                            <NavLink to='/main/At daybreak of the fifteenth day of my search'>
                                <img src="../img-news/Link-img/link-10.jpg"/></NavLink>
                        </div>
                        <div className="content-info">
                    ...
                    <div className="content">
                        <div className="content-img">
                            <NavLink to='/main/We Are Testing A Pagination Here'>
                                <img src="../img-news/Link-img/link-9.jpg"/></NavLink>
                        </div>
                        <div className="content-info">
                    ...
                    <div className="content">
                        <div className="content-img">
                            <NavLink to='/main/A great thing made of gold. Down the hill I saw it.'>
                                <img src="../img-news/Link-img/link-8.jpg"/></NavLink>
                        </div>
                        <div className="content-info">
                            <NavLink to='/main/A great thing made of gold. Down the hill I saw it.'>  <h2 className="style-title">A great thing made of gold. Down the hill I saw it.</h2></NavLink>
                            <span className=" style-global-span-info letter-space-2">NOVEMBER 3, 2016</span>
                            <span className='padding-0-10'>.</span>
                            <NavLink to="/category/' Staff'S Picks'" className=" style-global-span-info letter-space-3 ">  STAFF'S PICKS </NavLink> ,
...
export default RlSectionRelatedPostsHero;